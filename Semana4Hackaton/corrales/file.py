#from Semana4Hackaton.corrales.asistencia import menuUsuario
#from Semana4Hackaton.corrales.asistencia import menuAsistencia
import os
import shutil
import time
import json
...
class Archivo:
 ...
 #      try:
 #           file = open(self.nombreArchivo, 'a')
 #           textoAgregar = "{}---{}---{}---{} \n".format(usuario.nombreU, usuario.apellidoU, usuario.dniU, usuario.codU)
 ...
 #           print(file)
    ...
    def toDic(self): # // NO ENTIENDO POR QUE NO LO RECONOCE
        d = {
    ...
    if(respuesta == "0"):
        ...
        while showUsuario:
            ...
            if(ansUsuario == "0"):
                ...
                usuario_listDic.append(usuario.toDic) # NO RECONEOCE LA VARIABLE  usuario_listDic.append(usuario.toDic) AttributeError: 'Usuario' object has no attribute 'toDic'
