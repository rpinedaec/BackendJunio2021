...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:pachaqtec2021@localhost:5432/miniblog'
...
def show_signup_form():
    ...
    return render_template("signup_form.html.j2", form=form, error=error)
